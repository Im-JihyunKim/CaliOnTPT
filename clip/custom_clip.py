...
class PromptLearner(nn.Module):
    def __init__(self, clip_model, classnames, batch_size=None, n_ctx=4, ctx_init=None, ctx_position='end', learned_cls=False, num_p=1, featinit=None, num_select_p=1):
        super().__init__()
...
class ClipTestTimeTuning(nn.Module):
    ...
    def inference(self, image, p_s=None):
        ...
        #[o-tpt] --------------------------------------------
        if self.l2_norm_cal: self.textfeatures_ = text_features
        #[o-tpt] --------------------------------------------
...
def get_coop(clip_arch, test_set, device, n_ctx, ctx_init, learned_cls=False, num_p=1, featinit=None, num_select_p=1):
