...
path_dict = {
    ...
    "flower102": ["jpg", "../data/json_split_files/split_zhou_OxfordFlowers.json"],
    "food101": ["images", "../data/json_split_files/split_zhou_Food101.json"],
    "dtd": ["images", "../data/json_split_files/split_zhou_DescribableTextures.json"],
    "pets": ["images", "../data/json_split_files/split_zhou_OxfordPets.json"],
    "sun397": ["SUN397", "../data/json_split_files/split_zhou_SUN397.json"],
    "caltech101": ["101_ObjectCategories", "../data/json_split_files/split_zhou_Caltech101.json"],
    "ucf101": ["", "../data/json_split_files/split_zhou_UCF101.json"],
    "cars": ["", "../data/json_split_files/split_zhou_StanfordCars.json"],
    "eurosat": ["2750", "../data/json_split_files/split_zhou_EuroSAT.json"]
}
